...
public class TBL_ProductAttributes {
    ...
    public TBL_ProductAttributes(){
        super();
    }

    public TBL_ProductAttributes(long Id, String Size, String Color, String Gender, String Brand) {
        super();
        this.Id = Id;
        this.Size = Size;
        this.Color = Color;
